<?php
    ...
    *
    * @Hook restrofood_blog_details_column_divider_start_wrapper
    *
    * @Hooked restrofood_blog_details_column_divider_start_wrapper_cb
    */
    do_action( 'restrofood_blog_details_column_divider_start_wrapper' );
    ...
    * @Blog Single Sidebar
    *
    * @Hook restrofood_blog_single_sidebar_wrapper
    *
    * @Hooked restrofood_blog_single_sidebar_wrapper_cb
    */
    do_action( 'restrofood_blog_single_sidebar_wrapper' );
