...
// image default alt
if( !function_exists( 'restrofood_img_default_alt' ) ){
	function restrofood_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'restrofood_img_tag' ) ){
	function restrofood_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = restrofood_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'restrofood_anchor_tag' ) ){
	function restrofood_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'restrofood_heading_tag' ) ){
	function restrofood_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'restrofood_paragraph_tag' ) ){
	function restrofood_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'restrofood_span_tag' ) ){
	function restrofood_span_tag( array $args ){
