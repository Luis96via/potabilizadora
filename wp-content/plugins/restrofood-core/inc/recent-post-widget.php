...
class restrofood_recent_post_widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			// Base ID of your widget
			'restrofood_recent_post_widget',
			// Widget name will appear in UI
			esc_html__( 'Restrofood :: Recent post', 'restrofood' ),
			// Widget description
			array(
				'description' 	=> esc_html__( 'Add recent post/Recent News/Latest Blog Content', 'restrofood' ),
...
public function widget( $args, $instance ) {
	...
	<div class="single-post media align-items-center">
        ...
        <div class="post-content media-body">
            <?php
                if( $show_date ){
                	echo restrofood_span_tag(array(
...
public function form( $instance ) {
	if ( isset( $instance[ 'title' ] ) ) {
		...
		$title = esc_html__( 'Recent Posts', 'restrofood' );
	}
	//Post Limit
...
?>
	<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>">
			<?php
				echo esc_html__( 'Title:' ,'restrofood');
			?>
		</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'post_number' ); ?>">
			<?php
				_e( 'Number of posts to show: ' ,'restrofood');
			?>
		</label>
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id( 'show_date' ); ?>">
			<?php
				_e( 'Display post date?' ,'restrofood');
			?>
		</label>
	</p>
<?php
...
function restrofood_recent_post_load_widget() {
	register_widget( 'restrofood_recent_post_widget' );
}
add_action( 'widgets_init', 'restrofood_recent_post_load_widget' );