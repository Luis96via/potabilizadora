...
class restrofood_contact_info_widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			// Base ID of your widget
			'restrofood_contact_info_widget',
			// Widget name will appear in UI
			esc_html__( 'Restrofood :: Contact Us', 'restrofood' ),
			// Widget description
			array(
				'description'	 => esc_html__( 'Add footer Contact Information content', 'restrofood' ),
...
public function form( $instance ) {
	...
	if ( isset( $instance[ 'title' ] ) ) {
		...
		$title = esc_html__( 'Get In Touch', 'restrofood' );
	}
	...
	if ( isset( $instance[ 'content' ] ) ) {
		...
		$content = esc_html__( 'Our support available to help you 24 hours a day & 7 days a week.', 'restrofood' );
	}
...
function restrofood_contact_info_load_widget() {
	register_widget( 'restrofood_contact_info_widget' );
}
add_action( 'widgets_init', 'restrofood_contact_info_load_widget' );