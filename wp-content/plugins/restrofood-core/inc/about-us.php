...
class restrofood_about_us extends WP_Widget {
	function __construct() {
		parent::__construct(
			// Base ID of your widget
			'restrofood_about_us',
			// Widget name will appear in UI
			esc_html__( 'Restrofood :: About Us', 'restrofood' ),
			// Widget description
			array(
				'description' 	=> esc_html__( 'Add About Us Widget', 'restrofood' ),
...
?>
	<p>
		...
		<div class="moderna-admin">
			<button class="button button-secondary" id="logo_image"><?php esc_html_e( 'Upload Image','restrofood' );?></button>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'social_icon' ); ?>">
			<?php
				_e( 'Enable Social Icon' ,'restrofood' );
			?>
		</label>
...
function restrofood_about_us_widget() {
	register_widget( 'restrofood_about_us' );
}
add_action( 'widgets_init', 'restrofood_about_us_widget' );